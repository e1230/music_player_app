...
import 'package:music_player_app/src/widgets/custom_appbar.dart';
      ...
      children: [
        ...
        Column(
          children: [
            ...
            _Titulo(),
            Expanded(child: _Lyrics(letras: letras))
          ],
        ),
      ],
    ));
...
class _TituloState extends State<_Titulo> with SingleTickerProviderStateMixin {
  ...
  void open() {
    ...
    assetAudioPlayer.current.listen((playingDuration) {
      audioPlayerModel.songDuration =
          playingDuration?.audio.duration ?? Duration(seconds: 0);
    });
  }
